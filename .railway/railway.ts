...
export default defineRailway(() => {
  ...
  const nosBbqOMatic = service("nos-bbq-o-matic", {
    source: github("seyone22/nos-bbq-o-matic", {
      branch: "master",
      checkSuites: false,
    }),
    ...
    env: {
      ...
      NEXT_PUBLIC_R2_PUBLIC_BASE: preserve(),
      ...
      R2_TOKEN_VALUE: preserve(),
    },
  });
  const FoodRepo = service("Food Repo", {
    source: github("seyone22/ingredient-database-api", {
      branch: "master",
      checkSuites: false,
    }),
  ...
  return project("Cook", {
    resources: [postgresVolume, NOSBBQOMatic, FoodRepo2, Common],
  });
});
