        ...
        <div className="max-w-3xl w-full space-y-10 text-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-2xl mx-auto">
              FoodRepo aggregates detailed ingredient data and relationships to
              help cooks, developers, and researchers understand the origins,
              flavors, and cultural context of ingredients.
            </p>
          </div>
          ...
          <Card className="max-w-2xl mx-auto border-dashed shadow-sm bg-muted/30">
            <CardContent className="p-6 sm:p-8">
              <p className="text-base sm:text-lg text-foreground">
                ...
                <strong className="font-semibold text-primary">freely</strong>{" "}
                for anyone to use. Feel free to explore, integrate, or expand
                upon it.
              </p>
            </CardContent>
          </Card>
