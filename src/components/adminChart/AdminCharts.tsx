...
export default function AdminCharts({
  ...
  const mergedGrowthData = useMemo(() => {
    return growth.products.map((p) => {
      const date = p.date;
      const ingCount =
        growth.ingredients.find((i) => i.date === date)?.count || 0;
    ...
    <div className="flex flex-col gap-6 mt-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>
              Ingredient origins by broad region
            </CardDescription>
          </CardHeader>
          <CardContent className="flex justify-center pb-0">
            ...
            >
              <PieChart>
                ...
                <ChartLegend
                  content={
                    <ChartLegendContent className="-translate-y-2 flex-wrap gap-2" />
                  }
                />
              </PieChart>
            </ChartContainer>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>
              Breakdown by primary taste characteristics
            </CardDescription>
          </CardHeader>
          <CardContent className="flex justify-center pb-0">
            <ChartContainer
        ...
        <Card className="lg:col-span-3">
          <CardHeader>
            ...
            <CardDescription>
              Most commonly associated culinary styles
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ChartContainer config={barConfig} className="h-[300px] w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        <Card className="lg:col-span-3">
          <CardHeader>
            ...
            <CardDescription>
              Most utilized ingredients in the database
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ChartContainer config={barConfig} className="h-[300px] w-full">
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>
              Origin distribution of mapped products
            </CardDescription>
          </CardHeader>
          <CardContent className="flex justify-center pb-0">
            <ChartContainer
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Tracking cumulative additions across core metrics
          </CardDescription>
        </CardHeader>
        <CardContent>
